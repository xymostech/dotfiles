...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((t (:foreground ,molokai-fg
                             :background ,molokai-grey+5
                             :box nil))))

   ;; search
   `(isearch ((t (:foreground ,molokai-dark
                  :background ,molokai-wheat
                  :weight bold))))
   `(isearch-fail ((t (:foreground ,molokai-wine :background ,molokai-darkwine))))

   ;; linum-mode
   `(linum ((t (:foreground ,molokai-grey-1 :background ,molokai-grey+8))))
